...
namespace RegisterAndLoginProj.Services
{
    ...
    {
        bool success = false;
        string connectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=CodingSchool;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=True;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        ...
        public bool FindUserByNameAndPassword(UserModel user)
        {
            ...
            */
            string sqlStatement = @"Select * from dbo.test where UserName = @username AND Password = @password";
